CSS_INLINE = """<style>
  ...
  .summary-header { border-bottom: 3px solid #00135B; padding-bottom: 1rem; margin-bottom: 2rem; break-inside: avoid; page-break-inside: avoid; }
  ...
  .summary-section { margin-bottom: 2rem; break-inside: avoid; page-break-inside: avoid; }
  ...
  .risk-grid { display: grid; grid-template-columns: 1fr 1fr; gap: 1rem; break-inside: avoid; page-break-inside: avoid; }
  .risk-card { border-radius: 8px; padding: 1rem; break-inside: avoid; page-break-inside: avoid; }
  ...
  .mitigation-list { padding-left: 1.5rem; margin: 0; break-inside: avoid; page-break-inside: avoid; }
  .mitigation-list li { margin-bottom: 0.75rem; font-size: 0.875rem; color: #000000 !important; line-height: 1.7; break-inside: avoid; page-break-inside: avoid; }
  .mitigation-note { font-size: 0.8rem; color: #64748b !important; font-style: italic; margin-top: 0.5rem; }
  .recommendation-section { background: #EEF2F8 !important; border-radius: 12px; padding: 1.5rem; break-inside: avoid; page-break-inside: avoid; }
